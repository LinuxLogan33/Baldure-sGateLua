...
SetPrivateProfileString('Graphics','renderer','Intel(R) UHD Graphics')
...
SetPrivateProfileString('Lua Edit','String0',' CLUAConsole:CreateItem("boot01")')
SetPrivateProfileString('Lua Edit','String6','')
SetPrivateProfileString('Lua Edit','String9','')
SetPrivateProfileString('Lua Edit','String1',' CLUAConsole:CreateItem("boot01")')
...
SetPrivateProfileString('Program Options','Volume Music','0')
SetPrivateProfileString('Program Options','Volume Voices','35')
...
SetPrivateProfileString('Game Options','Last Save','000000001-Quick-Save-2')
...
SetPrivateProfileString('Game Options','Difficulty Level','4')
SetPrivateProfileString('Game Options','Always Dither','1')
SetPrivateProfileString('Game Options','Environmental Audio','1')
SetPrivateProfileString('Game Options','Auto Pause State','1664')
...
SetPrivateProfileString('Game Options','Message Box Top','55')
...
SetPrivateProfileString('Game Options','Keyboard Scroll Speed','64')
...
SetPrivateProfileString('Game Options','Mouse Scroll Speed','64')
